...
public class Practice1Minimum {
    ...
    private static int findMinOf3(int a, int b, int c) {
        ...
        System.out.print( "Lowest of " + a + ", " + b + " and " + c + " is " + lowestIntOf3 + ".\n" );
        return lowestIntOf3;
    }
    ...
    private static int findMinOf4(int a, int b, int c, int d) {
        ...
        System.out.print( "Lowest of " + a + ", " + b + ", " + c + " and " + d + " is " + lowestIntOf4 + ".\n" );
        return lowestIntOf4;
    }
    ...
    public static void main( String[] mainArgs ) {
        ...
        switch (x) {
            case 2:
                ...
                break;
            case 3:
                result = findMinOf3( parsedMain[0], parsedMain[1], parsedMain[2] );
                break;
            case 4:
                result = findMinOf4( parsedMain[0], parsedMain[1], parsedMain[2], parsedMain[3] );
                break;
            default:
